...
**Acceptance criteria:**
- [ ] All 5 navigation links resolve to real pages
- [ ] Pages use Navigation + Footer components
- [ ] Pages have both DE and EN translations
...
- [ ] Language toggle switches all text on all pages
...
**Acceptance criteria:**
- [ ] User interface shows role selection during signup
- [ ] Role persisted in localStorage
- [ ] `isAdmin`, `isPolitician`, `isInnovator` booleans available in context
...
**Acceptance criteria:**
- [ ] Partner logos display or show graceful fallback
